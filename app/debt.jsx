...
export default function DebtScreen() {
  ...
  const updateDebtDetails = useStore((state) => state.updateDebtDetails);
  ...
  const handleAddDebt = async () => {
    ...
    await addDebt(newName.trim(), parseInt(newAmount), newDueDate || null);
    setNewName("");
    setNewAmount("");
    setNewDueDate("");
  ...
  const handlePay = async () => {
    ...
    await updateDebtRemaining(selectedDebt.id, remaining);
    setPayAmount("");
